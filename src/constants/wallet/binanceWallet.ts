...
const detectInMobile = () => {
  ...
  return check || isMobileWidth;
};
export const BinanceWallet = ({
  projectId,
  walletConnectParameters,
}: MyWalletOptions): Wallet => {
  const isMobile = detectInMobile();
  // const isBinanceInjected = hasInjectedProvider({ namespace: "BinanceChain" });
  ...
  return {
    ...
    createConnector: !shouldUseInjected
      ? getWalletConnectConnector({
          projectId,
          walletConnectParameters,
        })
