                ...
                <TableRow key={index} className="py-5">
                  <TableCell>
                    <TableItem className="flex items-center">
                      ...
                      <span className="tag tag-green ml-[0.44rem] px-[1rem] py-[0.12rem]">
                        2x boost
                      </span>
                    </TableItem>
                  </TableCell>
                  <TableCell>
                    <TableItem>
                      ...
                      <div className="sub-value mt-[0.12rem]">
                        ${getTotalTvl(item?.symbol)?.tvl}
                      </div>
                    </TableItem>
                  </TableCell>
                  <TableCell>
                    <TableItem className="flex items-center gap-[0.44rem]">
                      <span className="tag tag-gradient-blue px-[1rem] py-[0.12rem]">
                        EL Points
                      </span>
                      <span className="tag tag-gradient-purple px-[1rem] py-[0.12rem]">
                        Kelp Miles
                      </span>
                      <span className="tag tag-gradient-green px-[1rem] py-[0.12rem]">
                        ZKL Points
                      </span>
                    </TableItem>
                  </TableCell>
