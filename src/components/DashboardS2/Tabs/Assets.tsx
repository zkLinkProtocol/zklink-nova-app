        ...
        <div className="overflow-x-auto">
          <List className="min-w-[900px]">
            <div className="list-header flex items-center">
              <div className="list-header-item text-left">{t("dashboard.token")}</div>
              <div className="list-header-item text-center">{t("dashboard.points_booster")}</div>
              <div className="list-header-item text-center">{t("dashboard.nova_tvl")}</div>
              <div className="list-header-item text-center">{t("dashboard.ur_deposit")}</div>
