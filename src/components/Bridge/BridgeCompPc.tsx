                    ...
                    {loyalPoints > 0 && (
                      <Tooltip
                        ...
                        content={
                          <LoyaltyBoostTooltipContent>
                            <p className="mb-8">
                              Thank you for your continued support of zkLink. As
                              our loyal user, we're delighted to offer you{" "}
                  ...
                  <div className="flex items-center justify-between mb-2 points-box">
                    <div className="flex items-center">
                      ...
                      <ReactTooltip
                        ...
                        render={() => (
                          <p>
                            Previous zkLink Coinlist whitelist users taking part
                            in the zkLink Aggregation Parade will receive 50
                            Nova Points, Equivalent to depositing{" "}
                  ...
                  <div className="flex items-center justify-between mb-2 points-box">
                    <div className="flex items-center">
                      ...
                      <ReactTooltip
                        ...
                        render={() => (
                          <p>
                            NovaChadNFT holders will receive Mystery Box after
                            joining the Aggregation Parade.
                          </p>
                        )}
                      />
                    </div>
                  ...
                  <div className="flex items-center justify-between mb-2 points-box">
                    <div className="flex items-center">
                      ...
                      <Tooltip
                        ...
                        content={
                          <LoyaltyBoostTooltipContent>
                            All supported source tokens with the same entity
                            from different networks can be merged into a single
                            merged token. Holding or using merged token to
                            engage with supported dApps could receive higher
                            multipliers.{" "}
                            <a
            ...
            >
              Deposit through zkLink Nova Portal now
                  ...
                  >
                    <img
                      width={32}
                      height={32}
                      src="/img/icon-bridge-wallet.svg"
                    />
              ...
              {isFirstDeposit && showNoPointsTip && (
                <div className="mt-8 px-6 py-4 border-solid border-1 border-[#C57D10] rounded-lg flex">
                  ...
                  />
                  <p className="text-[#C57D10] ">
                    Should you wish to participate in the Aggregation Parade,
                    the minimum deposit value in a{" "}
                    <span className="font-bold">single transaction</span> should
                    be {minDepositValue} ETH or equivalence. To participate OKX
