...
import { AiOutlineCheck, AiOutlineDown, AiOutlineUp, AiOutlineSearch } from 'react-icons/ai'
...
const fromList = [
    { label: 'Linea Goerli Testnet', icon: lineaIcon },
    { label: 'Ethereum Goerli Testnet', icon: ethereumIcon },
]
// const toList = [{ label: 'zkLink Nova Testnet', value: '1' }]
const tokenList = [{ label: 'ETH', desc: 'Ether', value: 0, icon: ethIcon }]
        ...
        <>
            <div className='block lg:flex md:py-24 py-12'>
                <div className='px-8 md:px-16 lg:px-32 lg:w-1/2'>
                    <h2 className='text-3xl'>Bridge to Earn Yield and token rewards on zkLink Nova.</h2>
                    <div className='text-base mt-10'>
                        <p>You will earn one of the four Nova SBT once you bridge any amount of supported token into zkLink Nova.</p>
                        <div className='py-4'>
                            <OTPInput
                        ...
                        <p>
                            Upon collecting your SBT, you can upgrade it into an ERC7221 NFT through collecting 4 different types of trademark NFT
                        ...
                        <p className='mt-8'>Once you upgrade your SBT into , here are the Utility</p>
                    </div>
            ...
            <Modal
                ...
                <ModalContent>
                    <ModalHeader className='flex flex-col gap-1 text-3xl'>From</ModalHeader>
            ...
            <Modal
                ...
                <ModalContent>
                    <ModalHeader className='flex flex-col gap-1 text-3xl'>Choose Token</ModalHeader>
                    <ModalBody className='pb-8'>
                        <div>
                            <Input
                                ...
                                startContent={<AiOutlineSearch className='text-2xl text-gray-400' />}
                            />
                        </div>
