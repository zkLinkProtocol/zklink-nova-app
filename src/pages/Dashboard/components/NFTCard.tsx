        ...
        <>
                ...
                <div className='nft-left'>
                    <div className='flex justify-between'>
                        <div>
                            ...
                            <p className='mt-2 text-sub-title'>Invite to earn more pieces and upgrade your Nova Char</p>
                        </div>
                        <Button>Buy</Button>
                    </div>
            ...
            <Modal
                ...
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className='flex flex-col gap-1'>Open the Mystery box</ModalHeader>
                            <ModalBody>
                                <div className='flex justify-center items-center mx-auto w-48 h-48 bg-white text-black text-xl'>Mystery Box</div>
                            </ModalBody>
                            <ModalFooter>
